			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Registro</span> - Alumnos</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_wizard.html" class="breadcrumb-item">Formulario</a>
						...
						<fieldset>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Turno:</label>
										<input type="text" name="tel" class="form-control" placeholder="" data-mask="+99-99-9999-9999">
									</div>
								</div>

								<div class="col-md-6">
									<label>Especialidad, grado y grupo:</label>
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<select name="birth-month" data-placeholder="Especialidad" class="form-control form-control-select2" data-fouc>
													<option></option>
													<option value="1">ITI</option>
													<option value="2">IM</option>
													<option value="3">ISA</option>
													<option value="4">LAYGE</option>
													<option value="5">ITM</option>
												</select>
											</div>
										</div>											
									<div class="col-md-4">
											<div class="form-group">
												<select name="birth-day" data-placeholder="Grado" class="form-control form-control-select2" data-fouc>
													...
													<option value="19">7°-1</option>
													<option value="20">7°-2</option>
													<option value="21">7°-3</option>
													<option value="22">8°-1</option>
													<option value="23">8°-2</option>
													<option value="24">8°-3</option>
													<option value="25">9°-1</option>
													<option value="26">9°-2</option>
													<option value="27">9°-3</option>
													<option value="28">10°-1</option>
													<option value="29">10°-2</option>
