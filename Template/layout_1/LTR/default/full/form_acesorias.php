			...
			<div class="content">
	            ...
	            <div class="card">
					<div class="card-header bg-white header-elements-inline">
						<h6 class="card-title">Acessorias</h6>
						...
						<fieldset>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Nombre:</label>
										<input type="text" name="name" class="form-control" placeholder="Alfonso Zavala">
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="email" name="email" class="form-control" placeholder="19*****">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Tema:</label>
										<input type="text" name="tel" class="form-control" placeholder="Aritmetica, quimica, etc..." data-mask="+99-99-9999-9999">
									</div>
								</div>
								...
								<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<select name="birth-month" data-placeholder="ITI" class="form-control form-control-select2" data-fouc>
													<option></option>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
		                                ...
		                                <input type="text" name="degree-level" placeholder="01******" class="form-control">
	                                </div>							
	                            </div>
