			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					...
					<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Main</div> <i class="icon-menu" title="Main"></i></li>
						...
						<li class="nav-item">
							<a href="form_materias.html" class="nav-link">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="form_wizard.html" class="nav-link">Formulario para alumnos</a></li>
								<li class="nav-item"><a href="form_maestros.html" class="nav-link">Formulario  para maestros</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Registro</span> - Pago de camion</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Camion</span>
						</div>
						...
						<fieldset>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Horario:</label>
										<input type="text" name="tel" class="form-control" placeholder="" data-mask="">
									</div>
								</div>
