			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Registro</span> - Maestros</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Maestros</span>
						</div>
                	...
                	<form class="wizard-form steps-basic" action="#" data-fouc>
						...
						<div class="row">
							...
							<div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Grupo/Grupos impartidos:</label>
										<input type="text" name="name" class="form-control" placeholder="ITI 1°-1, ITMS 2°-3, etc...">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<select name="birth-month" data-placeholder="Mes" class="form-control form-control-select2" data-fouc>
													<option></option>
										...
										<div class="col-md-4">
											<div class="form-group">
												<select name="birth-day" data-placeholder="Dia" class="form-control form-control-select2" data-fouc>
													<option></option>
										...
										<div class="col-md-4">
											<div class="form-group">
												<select name="birth-year" data-placeholder="Año" class="form-control form-control-select2" data-fouc>
													<option></option>
