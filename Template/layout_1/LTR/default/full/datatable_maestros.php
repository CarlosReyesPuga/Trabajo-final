					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								...
								<td>ITI</td>
								<td>Matutino</td>
								<td>ITI 1°-1, ITS 2°-2</td>
								<td>AR19301@upv.edu.mx</td>
								<td>8345670912</td>
								<td><span class="badge badge-success">Conectado</span></td>
							...
							<tr>
								...
								<td>ITI</td>
								<td>Matutino</td>
								<td>ITI 1°-1, ITI 2°-2</td>
								<td>JF19303@upv.edu.mx</td>
								<td>8345670912</td>
								<td><span class="badge badge-danger">Desconectado</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
							...
							<tr>
								...
								<td>ISA</td>
								<td>Matutino</td>
								<td>LAYGE 3°-1, LAYGE 7°-2</td>
								<td>AR19301@gob.com.mx</td>
								<td>8345709123</td>
							...
							<tr>
								...
								<td>ISA</td>
								<td>Matutino</td>
								<td>ISA 6°-1, ISA 9°-2</td>
								<td>AG19304@upv.edu.mx</td>
								<td>8345470912</td>
								<td><span class="badge badge-success">Conectado</span></td>
								<td class="text-center">
									<div class="list-icons">
							...
							<tr>
								...
								<td>ISA</td>
								<td>Matutino</td>
								<td>ISA 1°-1, ISA 2°-2</td>
								<td>RJ19305@upv.edu.mx</td>
								<td>8345670910</td>
								<td><span class="badge badge-danger">Desconectado</span></td>
								<td class="text-center">
									<div class="list-icons">
							...
							<tr>
								...
								<td>ITM</td>
								<td>Vespertino</td>
								<td>ITM 9°-1, ITM 7°-2</td>
								<td>CP19307@upv.edu.mx</td>
								<td>8345670812</td>
								<td><span class="badge badge-secondary">Inactivo</span></td>
								<td class="text-center">
									<div class="list-icons">
							...
							<tr>
								...
								<td>ITI</td>
								<td>Vespertino</td>
								<td>ITI 1°-1, ISA 2°-2</td>
								<td>AM19309@upv.edu.mx</td>
								<td>8345600912</td>
								<td><span class="badge badge-success">Conectado</span></td>
								<td class="text-center">
									<div class="list-icons">
